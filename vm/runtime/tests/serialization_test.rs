...
use pulse_ast::{ActorId, Chunk, Constant, Function, Object, Value};
...
fn test_non_serializable_fails() {
    ...
    use pulse_ast::object::AtomicInt as PulseAtomicInt;
    use pulse_ast::Object::AtomicInt;
