use pulse_ast::object::Object;
use pulse_ast::{NativeFn, Value};
use pulse_vm::VM;
use std::collections::HashMap;

pub fn load_std_module(name: &str, vm: &mut VM) -> Option<pulse_ast::object::ObjHandle> {
...
fn add_native(
    name: &str,
    func: pulse_ast::value::SyncNativeFn,
...
fn add_native_async(
    name: &str,
    func: pulse_ast::value::AsyncNativeFn,
    exports: &mut HashMap<String, Value>,
    vm: &mut VM,
) {
    let native = NativeFn {
