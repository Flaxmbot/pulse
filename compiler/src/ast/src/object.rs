...
pub use crate::value::PulseWebSocket;
...
impl<'de> Deserialize<'de> for SharedMemory {
        ...
        D: Deserializer<'de>,
    {
        Err(serde::de::Error::custom(
            "Cannot deserialize SharedMemory - needs runtime allocation",
        ))
    }
}
...
impl Serialize for BoundMethod {
        ...
        S: Serializer,
    {
        ...
        Err(serde::ser::Error::custom(
            "Cannot serialize BoundMethod - contains runtime references",
        ))
    }
}
...
impl<'de> Deserialize<'de> for BoundMethod {
    ...
    {
        Err(serde::de::Error::custom(
            "Cannot deserialize BoundMethod - needs runtime allocation",
        ))
    }
}
...
impl Serialize for Object {
        ...
        S: Serializer,
    {
        ...
        match self {
            ...
            Object::Upvalue(_) => Err(serde::ser::Error::custom(
                "Cannot serialize Upvalue - runtime handle",
            )),
            Object::List(list) => {
                let mut s = serializer.serialize_struct("Object", 2)?;
            ...
            Object::BoundMethod(_) => Err(serde::ser::Error::custom(
                "Cannot serialize BoundMethod - runtime reference",
            )),
            Object::Set(set) => {
                let mut s = serializer.serialize_struct("Object", 2)?;
            ...
            Object::SharedMemory(_) => Err(serde::ser::Error::custom(
            ...
            Object::SharedBuffer(_) => Err(serde::ser::Error::custom(
                "Cannot serialize SharedBuffer - runtime reference",
            )),
            Object::Socket(_) => Err(serde::ser::Error::custom(
                "Cannot serialize Socket - runtime reference",
            )),
            Object::WebSocket(_) => Err(serde::ser::Error::custom(
                "Cannot serialize WebSocket - runtime reference",
            )),
            Object::Listener(_) => Err(serde::ser::Error::custom(
                "Cannot serialize Listener - runtime reference",
            )),
            Object::Regex(_) => Err(serde::ser::Error::custom(
                "Cannot serialize Regex - contains compiled pattern",
            )),
        }
    }
}
...
impl<'de> Deserialize<'de> for Object {
    ...
    {
        Err(serde::de::Error::custom(
            "Cannot deserialize Object directly - use ObjectRef or specific deserialize methods",
        ))
    }
}
...
impl<'de> Deserialize<'de> for Class {
    ...
    {
        Err(serde::de::Error::custom(
            "Cannot deserialize Class directly - class definitions must be loaded from module",
        ))
    }
}
...
impl<'de> Deserialize<'de> for Upvalue {
    ...
    {
        Err(serde::de::Error::custom(
            "Cannot deserialize Upvalue - runtime allocation required",
        ))
    }
}
